...
export function getHeadValueRowCellId(column: HeadColumnDescriptor | DataColumnDescriptor<any>) {
...
export function getBodyRowCellId(rowIndex: number, column: HeadColumnDescriptor | DataColumnDescriptor<any>) {
    if (column.type === 'head-column') {
